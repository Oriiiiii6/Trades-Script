        ...
        for _, location in pairs(Config.TradeLocations) do
            ...
            if dist < Config.InteractDistance then
                ...
                if IsControlJustPressed(0, 38) then 
                    TriggerServerEvent("ori-trades:startTrade")
                end
            end
        end
...
RegisterNetEvent("ori-trades:openMenu", function()
    local menuOptions = {}
...
RegisterNetEvent("ori-trades:tradeItem", function(data)
    TriggerServerEvent("ori-trades:processTrade", {
